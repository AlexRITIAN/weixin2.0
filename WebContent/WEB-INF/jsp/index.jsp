			...
			<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
				<nav class="link-effect-2" id="link-effect-2">
					<ul class="nav navbar-nav">
						<li class="active"><a href="/BServlet?state=index"><span data-hover="Home">Home</span></a></li>
						<li><a href="courses.html"><span data-hover="Courses">Courses</span></a></li>
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><span data-hover="Jenkins">Jenkins</span> <b class="caret"></b></a>
							<ul class="dropdown-menu agile_short_dropdown">
								<li><a href="/BServlet?state=server_status">All</a></li>
								<li><a href="/BServlet?state=jenkins_red">Red Project</a></li>
								<li><a href="/BServlet?state=jenkins_restart">Restart</a></li>
								<li><a href="/BServlet?state=jenkins_upload">Upload</a></li>
							</ul>
						</li>
						<!-- <li class="dropdown">
		...
		<div class="container">
			<div class="agile_banner_info">
				<div class="agile_banner_info1">
					<h3>We are <span>Lenovo</span></h3>
					<div id="typed-strings" class="agileits_w3layouts_strings">
						<p>We <i>PLAN</i> before we pledge</p>
						<p>We <i>PERFORM</i> as we promise</p>
						<p>We <i>PRIORITIZE</i> company first</p>
						<p>We <i>PRACTICE</i> improving every day</p>
						<p>We <i>PIONEER</i> new ideas</p>
					</div>
