			...
			success : function(data) {
				if (data != null) {
					...
					for (var i = 0; i < data.length; i++) {
						var jsonText = JSON.stringify(data[i].healthReport);
					...
					var pro_fail_p = document.getElementById("pro_fail_p");
					var pro_nobuilt_p = document.getElementById("pro_nobuilt_p");
					var pro_success_p = document.getElementById("pro_success_p");
					var pro_pro_p = document.getElementById("pro_pro_p");
					pro_fail_p.innerHTML = fail_num;
					pro_nobuilt_p.innerHTML = nobuilt_num;
					pro_success_p.innerHTML = success_num;
					pro_pro_p.innerHTML = total;
				}
			}
...
<!-- banner -->
	...
	<nav class="navbar navbar-default">
		...
		<div class="wthree_banner1_info">
			<div class="container">
				<h3><span>S</span>erver Status</h3>
			</div>
		</div>
	</div>
<!-- //banner -->	
